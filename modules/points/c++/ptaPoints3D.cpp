/*
 * ptaPoints3D — points3d([[x,y,z],...]) の計算本体 (#3528)。値配列から 3D 点群を作る leaf op。
 *
...
#include	"_ts2/c++/ptaPoints3D_.h"

CLASS_TINYSTATE(pt/c++/ptaPoints3D,pig/c++/ptsCalcBody)
...
ptaPoints3D_::ptaPoints3D_(TS_ARGS0)
