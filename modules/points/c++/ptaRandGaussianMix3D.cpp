/*
 * ptaRandGaussianMix3D — rand_gaussian(pt-cloud3d, sigma, n, seed) の計算本体 (#3577 ・ 2026-09-22)。
 ...
 *
 * ★★ この行は **sig が選ぶ** (第 1 引数が幾何なので insets=[pt-cloud3d])。
...
#include	"_ts2/c++/ptaRandGaussianMix3D_.h"

CLASS_TINYSTATE(pt/c++/ptaRandGaussianMix3D,pig/c++/ptsCalcBody)
...
ptaRandGaussianMix3D_::ptaRandGaussianMix3D_(TS_ARGS0)
...
sPtr<pigData>
ptaRandGaussianMix3D_::get_result()
{
