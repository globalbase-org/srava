/*
 * ptaRandPt3D — rand(a, b, n, seed) の **軸 3 本** の行 (`rand#pt3d`) の計算本体。
 *   (2026-09-21 新設 ・ 2026-09-22 に #3572 で rand へ統合。行は第 1 引数の要素数が選ぶ。)
 *   軸ごとの区間 [a[k], b[k]] にランダムな点を n 個作り、pt-cloud3d で返す。
 *
...
#include	"_ts2/c++/ptaRandPt3D_.h"

CLASS_TINYSTATE(pt/c++/ptaRandPt3D,pig/c++/ptsCalcBody)
...
ptaRandPt3D_::ptaRandPt3D_(TS_ARGS0)
