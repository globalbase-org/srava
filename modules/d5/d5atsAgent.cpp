...
static const pigOpEntry OPS[] = {
	{ "d5_cube",   CUBE_IN,    1, AK_CACHE,  &mkCalcT<d5aCube>,   0, "->d5-mesh3d" },                 /* leaf producer */
	{ "d5_merge",  MERGE_IN,   2, AK_CACHE,  &mkCalcT<d5aMerge>,  0, "(d5-mesh3d,d5-mesh3d)->d5-mesh3d" },
	...
	{ "d5_nfaces", MEASURE_IN, 1, AK_INLINE, &mkCalcT<d5aNfaces>, 0, "(d5-mesh3d)->value;(mf-mesh3d)->value" },
	{ "d5_nverts", MEASURE_IN, 1, AK_INLINE, &mkCalcT<d5aNverts>, 0, "(d5-mesh3d)->value;(mf-mesh3d)->value" },
};
...
extern const pigModuleCodec d5_codecs[];   /* d5CacheCodec.cpp */
extern const srava_module_descriptor d5atsAgent_descriptor;
extern const srava_module_descriptor d5atsAgent_descriptor = {
	SRAVA_MODULE_ABI, "d5", 0,
	&mk_d5atsAgent, (unsigned)(EXEC_THREAD | EXEC_PROCESS), EXEC_THREAD,
	OPS, N_OPS, 0, 0,
	"D5M3",   /* codec_tags */
	d5_codecs,   /* reader/writer factory (自型 D5M3 + MFM3 昇格読み) */
	"d5-mesh3d", "D5M3",   /* types / type_tags (#3427 で manifest.cpp から移動) */
	"\x01" "D5M",   /* hash_salt: キャッシュキー弁別 (#3427 で manifest.cpp から移動) */
};
