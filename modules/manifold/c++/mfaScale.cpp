/*
 * mfaScale — scale(mesh, factor) の計算本体(ptsCalcBody 派生)。
...
#include	"_ts2/c++/mfaScale_.h"

CLASS_TINYSTATE(mf/c++/mfaScale,pig/c++/ptsCalcBody)
