/*
 * nfaNfaces — nfaces(mesh) — 境界表現に落としたときの頂点数 / 面数 (#3443)。
...
#include	"_ts2/c++/nfaNfaces_.h"

CLASS_TINYSTATE(nf/c++/nfaNfaces,pig/c++/ptsCalcBody)
...
nfaNfaces_::nfaNfaces_(TS_ARGS0)
...
nfaNfaces_::compute()
{
	...
	result = thNEW(pigDataInteger,((INTEGER64)nf));
}
