/*
 * nfaUnion — 2 つの Nef 多面体のunion (nef 版)。★Nef のまま返す (型維持・境界表現へ戻さない)。
 */
...
#include	<stdio.h>
#include	"_ts2/c++/nfaUnion_.h"

CLASS_TINYSTATE(nf/c++/nfaUnion,pig/c++/ptsCalcBody)
