/*
 * chaIcosphere — icosphere(r, subdiv) — 測地球 (正二十面体を細分) の計算本体 (cherchi 版・#3474)。
...
#include	"_ts2/c++/chaIcosphere_.h"

CLASS_TINYSTATE(ch/c++/chaIcosphere,pig/c++/ptsCalcBody)
...
chaIcosphere_::chaIcosphere_(TS_ARGS0)
