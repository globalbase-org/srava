/*
 * chaImport — import(path) — 外部メッシュ読み込み (STL / OFF) の計算本体 (cherchi 版・#3474)。
...
#include	"_ts2/c++/chaImport_.h"

CLASS_TINYSTATE(ch/c++/chaImport,pig/c++/ptsCalcBody)
...
chaImport_::chaImport_(TS_ARGS0)
