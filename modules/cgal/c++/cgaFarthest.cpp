/*
 * cgaFarthest — farthest(a, b) の計算本体(ptsCalcBody 派生)= 最遠の [距離, [pa], [pb]] を返す**配列返し op**。
 *   pa=a 上の点 / pb=b 上の点。3D-3D 専用(頂点ペア総当り・極値は頂点で厳密 O(n·m))。2D/混在はエラー。
 */
...
#include	"_ts2/c++/cgaFarthest_.h"

CLASS_TINYSTATE(cg/c++/cgaFarthest,pig/c++/ptsCalcBody)
...
cgaFarthest_::cgaFarthest_(TS_ARGS0)
