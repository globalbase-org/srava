/*
 * cgaTetrahedron — tetrahedron(r) — 正四面体 (原点中心・外接球半径 r) の計算本体 (cgal 版・#3474)。
...
#include	"_ts2/c++/cgaTetrahedron_.h"

CLASS_TINYSTATE(cg/c++/cgaTetrahedron,pig/c++/ptsCalcBody)
...
cgaTetrahedron_::cgaTetrahedron_(TS_ARGS0)
