/*
 * ptsd3WireCacheStreamWriterMesh — d3 mesh キャッシュ出力用 writer 派生 (rev4 Phase D-3)。
 * ptsmfWireCacheStreamWriterMesh のミラー。INIT で D_META タグ "D3M3" を書き、ACT_START で
 * d3Mesh::encode が chunk()=d_chunk を直接呼ぶ。基底が streamhdr/TSE_ASSERT/W_END/TSE_RETURN を担う。
 */
#include	"pig/c++/ptsObject.h"
#include	"pig/c++/ptsApplication.h"
#include	"d3/c++/d3Mesh.h"
#include	"_ts2/c++/ptsd3WireCacheStreamWriterMesh_.h"

CLASS_TINYSTATE(d3/c++/ptsd3WireCacheStreamWriterMesh,pig/c++/ptsWireCacheStreamWriter)
...
public:
	ptsd3WireCacheStreamWriterMesh_(
...
ptsd3WireCacheStreamWriterMesh_::ptsd3WireCacheStreamWriterMesh_(TS_ARGS0)
...
void
ptsd3WireCacheStreamWriterMesh_::chunk(const uint8_t *data, int n)
{
	d_chunk(data, n);
}
