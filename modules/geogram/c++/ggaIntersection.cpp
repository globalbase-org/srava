/*
 * ggaIntersection — intersection(a,b) の計算本体 (geogram 版)。mesh arrangement + 厳密述語による二項ブール。
 */
...
#include	<stdio.h>
#include	"_ts2/c++/ggaIntersection_.h"

CLASS_TINYSTATE(gg/c++/ggaIntersection,pig/c++/ptsCalcBody)
...
ggaIntersection_::ggaIntersection_(TS_ARGS0)
...
ggaIntersection_::compute()
{
	...
	char why[512];
	why[0] = '\0';
	mesh = ggMesh::bool_from_args(args, "intersection", &msg, why, (int)sizeof why);
	if ( ! mesh.is_notNull() ) {
