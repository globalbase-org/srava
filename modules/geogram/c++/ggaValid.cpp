/*
 * ggaValid — valid(m) — 妥当なら 1・そうでなければ 0。
 *
...
#include	"_ts2/c++/ggaValid_.h"

CLASS_TINYSTATE(gg/c++/ggaValid,pig/c++/ptsCalcBody)
...
ggaValid_::compute()
{
	...
	if ( ! in.is_notNull() ) {
		result = gga_err(thNEW(stdString,("valid: needs a geogram mesh")));
		return;
	}
