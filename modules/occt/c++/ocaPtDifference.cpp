/*
 * ocaPtDifference — difference(点群, 形, ...) — 点群を B-rep で切る (#3581)。
 *
  * difference(点群, 形) -> 点群 (形の **外側**の点) *
...
#include	"_ts2/c++/ocaPtDifference_.h"
#include	<stdio.h>

CLASS_TINYSTATE(oc/c++/ocaPtDifference,pig/c++/ptsCalcBody)
...
ocaPtDifference_::ocaPtDifference_(TS_ARGS0)
