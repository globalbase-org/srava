/*
 * ocaVolume — volume(s) の計算本体。★厳密な曲面のまま積分する (#3437 P5)。
 */
...
#include	"_ts2/c++/ocaVolume_.h"


CLASS_TINYSTATE(oc/c++/ocaVolume,pig/c++/ptsCalcBody)
...
ocaVolume_::ocaVolume_(TS_ARGS0)
